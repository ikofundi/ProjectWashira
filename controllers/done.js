            ...
            if (task === undefined) {
                ...
                if (task.ongoing === true) {
                    ...
                    task.save(function(err, task) {
                        ...
                        Technician.find({ "phoneNumber": task.fundiThatPickedTaskNumber })
                            .select('category firstName lastName email phoneNumber phoneNumber2 location idNumber ongoingJobs timeJobPicked jobsPicked jobsCompleted customerRating rating')
                            .exec(function(err, technician) {
                                if (err) return console.log(err);
